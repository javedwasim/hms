...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date("Y"); ?>
        <a target="_blank"  href="<?php echo SITEURL; ?>"><?php echo COMPANYNAME; ?></a>.</strong>
    All rights
    reserved.
</footer>
...
<script src="<?php echo base_url('/assets/dist/js/ekko-lightbox.min.js.map'); ?>"></script>

<script src="<?php echo base_url('/assets/bower_components/select2/dist/js/select2.full.min.js'); ?>"></script>
<script src="<?php echo base_url('/assets/bower_components/select2-tab-fix/src/select2-tab-fix.min.js'); ?>"></script>
