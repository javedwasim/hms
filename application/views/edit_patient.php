                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input tabindex=1 class="form-control"  type="text" value="<?php echo $p_key['emergency_no']; ?>" id="emNo" name="emNo" placeholder="Type Number" onkeypress="return /\d/.test(String.fromCharCode(((event || window.event).which || (event || window.event).which)));" />
                                                </div><!-- /.form-group -->
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input tabindex=2 class="form-control"  type="text" value="<?php echo $p_key['admi_no']; ?>" id="admNo" name="admNo" placeholder="Type Number" onkeypress="return /\d/.test(String.fromCharCode(((event || window.event).which || (event || window.event).which)));" />
                                                </div><!-- /.form-group -->
                                            </div><!-- /.col -->
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control"
                                                           type="text" id="patName" name="patName" placeholder="Type Name" value="<?php echo $p_key['patName']; ?>">
                                                </div><!-- /.form-group -->
                                            </div><!-- /.col -->
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select  class="form-control disease"
                                                            ...
                                                            <option></option>
                                                            <option value="<?php echo $p_key['patDisease_id']; ?>" selected><?php
                                    ...
                                    <div class="box-body">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" value="<?php echo $p_key['garName']; ?>" name="garName"  placeholder="Enter Guardian Name">
                                            </div>
                                        </div><!-- /.col -->
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>CNIC</label>
                                                <input class="form-control" type="text" value="<?php echo $p_key['garCnic']; ?>" name="garCnic" id="garcnic" placeholder="Type CNIC number" maxlength="15" autocomplete="off">
                                            </div><!-- /.form-group -->
                                        </div><!-- /.col -->
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Contact Number</label>
                                                <input class="form-control" type="text" value="<?php echo $p_key['garContact']; ?>" name="garPhone" placeholder="Type Phone Number" onkeypress="return /\d/.test(String.fromCharCode(((event || window.event).which || (event || window.event).which)));" maxlength="11" />
                                            </div><!-- /.form-group -->
                                        </div><!-- /.col -->
                                        <div class="col-md-3">
                                            <div class="form-group">
