        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="discharge-history-select form-control select2" name="search_discharged_by_cnic">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right search-discharged-by-from-date"
                               value="<?php echo isset($filter['from_date'])?$filter['from_date']:''; ?>"
                               id="search-discharged-by-from-date" name="search_discharged_by_from_date" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right search-discharged-by-to-date"
                            value="<?php echo isset($filter['to_date'])?$filter['to_date']:''; ?>"
                            id="search-discharged-by-to-date" name="search_discharged_by_to_date" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
