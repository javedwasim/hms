    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url('/dashboard/wards_list/'); ?>">OT Ward List</a></li>
        ...
        <section class="content">
                                    ...
                                    foreach ($wards_list as $index => $w_key) { ?>
                                        <tr role="row" class="odd">
                                            <td class="sorting_1" id="regNo">
                                                <?php echo $w_key['otwardId']; ?>
                                                <input type="hidden" id="wardId" value="<?php echo $w_key['otwardId']; ?>">
                                            </td>
                                            <td><?php echo $w_key['otwardName']; ?></td>
                                            <td>
                                                <button class="btn btn-default delete-ot-ward">
            ...
            <div class="box  box-primary new-ward" id="add-a-ward">
                <div class="box-header with-border">
                    <h3 class="box-title">Add new OT Ward</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                    class="fa fa-minus"></i></button>
                    </div>
