...
<html>
    <head>
        <title>Patient Revisit | <?php echo SITE_TITLE_TEXT; ?></title>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form name="search-discharged-patients" id="search-discharged-patients" method="get"
                                            ...
                                            <select class="discharge-patient-select form-control"
                                                    name="search_discharged_by_cnic" style="width: 100%;">
                                            </select>
                                        </form>
                                    </div>
                                </div>
...
if (!empty($patient_list)) {
    foreach ($patient_list as $p_key) {
        ?>
                            <form action="<?php echo base_url('dashboard/patient_revisit'); ?>" class="submit-form"
                                  method="post">
                                <div class="box  box-primary">
                                    <div class="box-header with-border" id="patient-info">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" required="required" type="hidden"
                                                           name="oldRegNumber" id="regName" placeholder="MR#"
                                                           value="<?php
                                                   if (!empty($old_regNo)) {
                                                       echo $old_regNo;
                                                   }
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input tabindex=1 class="form-control"  type="text" value="<?php echo $p_key['emergency_no']; ?>" id="emNo" name="emNo" maxlength="12" placeholder="Type Number" onkeypress="return /\d/.test(String.fromCharCode(((event || window.event).which || (event || window.event).which)));" />
                                                </div><!-- /.form-group -->
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input tabindex=2 class="form-control"  type="text" value="<?php echo $p_key['admi_no']; ?>" id="admNo" name="admNo" maxlength="12" placeholder="Type Number" onkeypress="return /\d/.test(String.fromCharCode(((event || window.event).which || (event || window.event).which)));" />
                                                </div><!-- /.form-group -->
                                            </div><!-- /.col -->
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input class="form-control" required="required" required="required"
                                                           type="text" id="patName" name="patName" maxlength="20" placeholder="Type Name"
        ...
        <?php } ?>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" maxlength="3"  type="text" name="patAge"
                                                           id="patAge" 
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>months</label>
                                                    <input class="form-control"  type="text" maxlength="2" name="patMonthAge"
                                                           id="patMonthAge" 
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>days</label>
                                                    <input class="form-control"  type="text" name="patDaysAge" maxlength="2" id="patDaysAge" 
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    <select required="required" class="form-control bld-grp"
        ...
        <?php } ?>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Disease</label>
                                                    <select required="required" class="form-control disease"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input class="form-control" required="required" type="text" id="occupation"
                                                       name="patOccupation" placeholder="Type Occupation" maxlength="20"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>CNIC</label>
                                                    <input class="form-control" required="required" type="text"
                                                           required="required" name="patCnic" id="cnic" maxlength="15"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" required="required" id="address"
                                                           name="patAddress" placeholder="Type Address" maxlength="60"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" required="required" type="phone" id="phone"
                                                           name="patPhone" placeholder="Type Phone Number" maxlength="11"
                                    ...
                                    <div class="box-body">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" value="<?php echo $p_key['garName']; ?>" name="garName" maxlength="20"  placeholder="Enter Guardian Name">
                                            </div>
                                        </div><!-- /.col -->
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>CNIC</label>
                                                <input class="form-control" type="text" value="<?php echo $p_key['garCnic']; ?>" name="garCnic" id="garcnic" maxlength="15" placeholder="Type CNIC number" maxlength="15" autocomplete="off">
                                            </div><!-- /.form-group -->
                                        </div><!-- /.col -->
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Contact Number</label>
                                                <input class="form-control" type="text" value="<?php echo $p_key['garContact']; ?>" name="garPhone" placeholder="Type Phone Number" maxlength="11" onkeypress="return /\d/.test(String.fromCharCode(((event || window.event).which || (event || window.event).which)));" maxlength="11" />
                                            </div><!-- /.form-group -->
                                        </div><!-- /.col -->
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select required="required" class="form-control admitted-th"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" required="required" type="text"
                                                       name="patShiftedFrom" id="Disease" maxlength="15" placeholder="Type Shifted From"
                                                       >
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select required="required" class="form-control ward-name" maxlength="10" style="width: 100%;"
                                                        name="wardName">
                                                </select>
                                            </div>
                                        </div><!-- /.col -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" class="form-control pull-right" id="datepicker1"
                                                           name="patAdmDate" autocomplete="off"
                                                           >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <input type="radio" required="required" name="freeCarePatient"
                                                       class="custom-radio entitled-rad" value="1"><label
                                                       class="radio-labels">Yes</label>
                                                <input type="radio" required="required" name="freeCarePatient"
                                                       class="custom-radio entitled-rad" value="0" checked><label
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn bg-blue margin" name="readmitPatient"><i
